...
/**
 * Bean de respuesta para la transacci&oacute;n <code>MPPM</code>
 * 
...
@Multiformato(formatos = {FormatoMPPM00S.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionMppm implements MensajeMultiparte {
