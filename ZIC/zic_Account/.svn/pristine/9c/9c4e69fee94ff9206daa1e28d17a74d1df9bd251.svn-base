...
/**
 * Bean de respuesta para la transacci&oacute;n <code>B000</code>
 * 
...
@Multiformato(formatos = {FormatoBGM0001.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionB000 implements MensajeMultiparte {
