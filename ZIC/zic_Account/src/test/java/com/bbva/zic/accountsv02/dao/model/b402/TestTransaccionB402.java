...
/**
 * Test de la transacci&oacute;n <code>B402</code>
 * 
...
public class TestTransaccionB402 {
	
	private static final Log LOG = LogFactory.getLog(TestTransaccionB402.class);
		
	@Autowired
	private TransaccionB402 transaccion;
	
	@Test
	public void test() throws ExcepcionTransaccion {
		
		PeticionTransaccionB402 peticion = new PeticionTransaccionB402();		
		...
		try {
			...
			RespuestaTransaccionB402 respuesta = transaccion.invocar(peticion);
